...
//-----------------------------------------------------------------------
void
si_stack_init(          // Function to init a fixed size int stack
    SI_Stack* const s)  // Pointer to stack to init
{
    s->top_ = 0;
}
...
si_stack_push(          // Function to push to stack 
    SI_Stack* const s,  // Ptr to a stack
...
si_stack_pop(  // Function to pop from stack
    SI_Stack* const s,     // Ptr to a stack
...
si_stack_top( // Function to return top val of stack
    const SI_Stack* const s, // Ptr to a stack
...
si_stack_empty(  // Function to check if stack empty
    const SI_Stack* const s) // Ptr to a stack
{
    return (s->top_ == 0);
}
...
si_stack_full(  // Function to check if stack full
    const SI_Stack* const s) // Ptr to a stack
{
...
//-----------------------------------------------------------------------
void
si_stack_print( // Function to print stack elements
    const SI_Stack* const s) // Ptr to a stack
{
